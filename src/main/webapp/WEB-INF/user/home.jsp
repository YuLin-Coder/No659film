...
<style type="text/css">
    ...
    #tuijian {
        width: 50%;
        height: 40px;
        background: -webkit-linear-gradient(left, #32CD32, #2E323B);
    }
    #jiao{
        float: right;
        width: 50%;
        height: 40px;
        background: -webkit-linear-gradient(right, #32CD32, #2E323B);
    }
    #jiao strong{
        float: right;
    }
    ...
    <div id="myCarousel" class="carousel slide">
        ...
        <div class="carousel-inner">
            <div class="item active">
                <!--
                <a href="filma?filmId=2"><img src="img/111.jpg" alt="First slide"></a>
                -->
                <a href=""><img src="img/111.jpg" alt="First slide"></a>

            </div>
            <div class="item">
                <!--
                <a href="filma?filmId=1"><img src="img/112.jpg" width="100%"></a>
                -->
                <a href=""><img src="img/112.jpg" width="100%"></a>

            </div>
            <div class="item">
                <!--
                <a href="filma?filmId=4"><img src="img/115.jpg" alt="Third slide"></a>
                -->
                <a href=""><img src="img/115.jpg" alt="Third slide"></a>
